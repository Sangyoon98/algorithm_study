...
class P181906 {
    public static void main(String[] args) {
        ...
        int answer1 = 1;
        int result1 = new P181906().solution(my_string1, is_prefix1);
        PRINT_RESULT(1, result1, answer1);

        String my_string2 = "banana";
        String is_prefix2 = "nan";
        int answer2 = 0;
        int result2 = new P181906().solution(my_string2, is_prefix2);
        PRINT_RESULT(2, result2, answer2);

        String my_string3 = "banana";
        String is_prefix3 = "abcd";
        int answer3 = 0;
        int result3 = new P181906().solution(my_string3, is_prefix3);
        PRINT_RESULT(3, result3, answer3);

        String my_string4 = "banana";
        String is_prefix4 = "bananan";
        int answer4 = 0;
        int result4 = new P181906().solution(my_string4, is_prefix4);

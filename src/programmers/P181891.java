...
class P181891 {
    public static void main(String[] args) {
        ...
        int n1 = 1;
        int[] answer1 = new int[]{1, 6, 2};
        int[] result1 = new programmers.P181891().solution(num_list1, n1);
        PRINT_RESULT(1, result1, answer1);

        int[] num_list2 = new int[]{5, 2, 1, 7, 5};
        int n2 = 3;
        int[] answer2 = new int[]{7, 5, 5, 2, 1};
        int[] result2 = new programmers.P181891().solution(num_list2, n2);

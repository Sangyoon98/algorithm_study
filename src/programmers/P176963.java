...
class P176963 {
    public static void main(String[] args) {
        ...
        int[] result1 = new P176963().solution(name1, yearning1, photo1);
        ...
        int[] result2 = new P176963().solution(name2, yearning2, photo2);
        ...
        int[] result3 = new P176963().solution(name3, yearning3, photo3);
